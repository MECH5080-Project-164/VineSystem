...
class PressureSensorNode(Node):
    def __init__(self):
        ...
        self.declare_parameters('i2c_bus', rclpy.Parameter.Type.INTEGER, '1')
        self.declare_parameters('i2c_address', rclpy.Parameter.Type.INTEGER, 0x16)
        self.declare_parameters('publish_rate_hz', rclpy.Parameter.Type.DOUBLE, 1.0)
        self.declare_parameters('mean_sample_size', rclpy.Parameter.Type.INTEGER, 10)
